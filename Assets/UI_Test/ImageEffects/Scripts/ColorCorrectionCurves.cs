...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorCorrectionCurves : PostEffectsBase
	{
        ...
        public override bool CheckResources ()
		{
            ...
            if (!rgbChannelTex)
                rgbChannelTex = new Texture2D (255, 4, TextureFormat.ARGB32, false, true);
            if (!rgbDepthChannelTex)
                rgbDepthChannelTex = new Texture2D (255, 4, TextureFormat.ARGB32, false, true);
            if (!zCurveTex)
                zCurveTex = new Texture2D (255, 1, TextureFormat.ARGB32, false, true);
