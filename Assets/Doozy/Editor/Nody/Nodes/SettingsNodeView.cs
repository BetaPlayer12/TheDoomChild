...
{
    public class SettingsNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(SettingsNode);
        ...
        public SettingsNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
