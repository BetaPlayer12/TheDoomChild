...
{
    [CustomEditor(typeof(SettingsNode))]
    public class SettingsNodeEditor : FlowNodeEditor
    {
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader.SetComponentNameText(ObjectNames.NicifyVariableName(nameof(SettingsNode))); //node name
