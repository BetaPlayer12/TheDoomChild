...
{
    [System.Serializable]
    public class TrialBossKit
    {
#if UNITY_EDITOR
        //[MenuItem("Tools/Kit/TrialBossKit")]
        //private static void open()
        //{
        //    var window = GetWindow<TrialBossKit>();
        //    window.position = GUIHelper.GetEditorWindowRect().AlignCenter(1920, 1080);
        //    window.PopulateList();
        //}

        [TableList(DrawScrollView = true, HideToolbar = true,AlwaysExpanded =true),OnInspectorGUI]
        public List<BossStatsKit> m_characterStatsList = new List<BossStatsKit>();

     

        [Serializable]
        public class BossStatsKit
        {
        ...
        {
            EditorUtility.DisplayProgressBar("Boss Progress", $"Gather All GameObjects", 0);
            ...
            for (int i = 0; i < prefabList.Count; i++)
            {
                ...
                EditorUtility.DisplayProgressBar("Boss Progress", $"Filtering{i}/{m_characterStatsList.Count}", i / (float)m_characterStatsList.Count);
            }
