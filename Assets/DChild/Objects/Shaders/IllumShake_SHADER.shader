...
Shader "Gian/Illum Shake" 
{
	...
	Properties 
	{
	    ...
	    [PerRendererData]_Illum ("Illumin (A)", 2D) = "white" {}
	    [PerRendererData]_Cutoff ("Alpha cutoff", Range(0,1)) = 0.5
	    [PerRendererData]_ShakeDisplacement ("Displacement", Range (0, 5.0)) = 1.0
	    [PerRendererData]_ShakeTime ("Shake Time", Range (0, 5.0)) = 0.5
	    [PerRendererData]_ShakeWindspeed ("Shake Windspeed", Range (0, 5.0)) = 0.5
	    [PerRendererData]_ShakeBending ("Shake Bending", Range (0, 5.0)) = 1.5
	    [PerRendererData]_WaveXmove("Wave X Move", Vector) = (0.024, 0.04, -0.12, 0.096) //Original
	    [PerRendererData]_WaveZmove("Wave Z Move", Vector) = (0.006, .02, -0.02, 0.1) //Original
	    //[PerRendererData]_WaveXmove("Wave X Move", Vector) = (0.1, 0.1, -0.1, 0.1) //Custom
	    //[PerRendererData]_WaveZmove("Wave Z Move", Vector) = (0.1, 0.1, -0.1, 0.1) //Custom*/
	}
