...
Shader "Gian/Illum Shake Instanced" 
{
	...
	Properties 
	{
        ...
        //NEW INSTANCE
        [MaterialToggle] GrassAnimation ("Grass Animation snap", Float) = 0
        [MaterialToggle] ReverseWind ("Reverse Wind Direciton", Float) = 0
	    ...
	    [PerRendererData]_ShakeTime ("Shake Time", Range (0, 5.0)) = 1.0
	    [PerRendererData]_ShakeWindspeed ("Shake Windspeed", Range (0, 5.0)) = 1.0
	    [PerRendererData]_ShakeBending ("Shake Bending", Range (0, 5.0)) = 1.0
	    [PerRendererData]_WaveXmove("Wave X Move", Vector) = (0.024, 0.04, -0.12, 0.096) //Original
	    [PerRendererData]_WaveZmove("Wave Z Move", Vector) = (0.006, .02, -0.02, 0.1) //Original
	}
	...
	SubShader 
	{
        ...
        #pragma multi_compile _ REVERSEWIND_ON //reverse wind
