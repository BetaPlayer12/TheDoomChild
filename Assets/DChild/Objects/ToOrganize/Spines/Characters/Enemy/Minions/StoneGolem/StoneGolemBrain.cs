...
{
    public class StoneGolemBrain : MinionAIBrain<StoneGolem>, IAITargetingBrain
    {
        [SerializeField]
        ...
        [SerializeField]
        [TabGroup("Ability Ranges")]
        private float m_attackChargeRange;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackChance;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackChargeChance;
        ...
        private void Behaviors()
        {
            switch (m_behaviorCount)
            {
                ...
                case 2:
                    ...
                    {
                        if (GetDistance() < m_attackChargeRange && m_behaviorChance < m_attackChargeChance && GetDistance() > m_castRange)
                        {
                            Vector2 pos = transform.position;
                            m_minion.AttackCharge(pos);
                            m_currentBehavior = 0;
                        }
                        else
                        {
        ...
        void Update()
        {
            ...
            else if (m_target != null)
            {
                ...
                m_lockBehavior = !m_minion.IsNormal();
                NormalMode();
                if (m_enablePatience)
                {
                    Patience();
