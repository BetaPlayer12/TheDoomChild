...
namespace DChild.Gameplay.Characters.Players.Modules
{
    public class PlayerCharacterController : MonoBehaviour, IMainController
    {
        ...
        private void Update()
        {
            ...
            if (m_airLunge.CanMove() == false)
            {
                m_airLunge.HandleMovementTimer();
            }
            ...
            if (m_reaperHarvest.CanMove() == false)
            {
            ...
            if (m_backDiver.CanMove() == false)
            {
                m_backDiver.HandleMovementTimer();
            }
        ...
        private void HandleAirBehaviour()
        {
            ...
            else
            {
                ...
                else if (m_input.backDiverPressed && m_backDiver.CanBackDiver())
                {
                    if (m_state.isInShadowMode == false)
                    {
                        m_basicSlashes?.Cancel();
        ...
        private void HandleGroundBehaviour()
        {
            ...
            else if (m_state.isCrouched && m_earthShaker.CanEarthShaker())
            {
                if (m_state.canAttack)
                {
                    ...
                    else if (m_input.sovereignImpalePressed)
                    {
                        if (m_state.isInShadowMode == false)
                        {
                            PrepareForGroundAttack();
            ...
            else
            {
                ...
                if (m_state.canAttack)
                {
                    ...
                    else if (m_input.reaperHarvestPressed)
                    {
                        if (m_state.isInShadowMode == false)
                        {
                            PrepareForGroundAttack();
                    ...
                    else if (m_input.doomsdayKongPressed)
                    {
                        if (m_state.isInShadowMode == false)
                        {
                            PrepareForGroundAttack();
                ...
                else if (m_input.jumpPressed && !m_input.backDiverPressed /*&& m_backDiver.CanBackDiver()*/ && m_earthShaker.CanEarthShaker())
                {
                    if (m_state.isInShadowMode == false)
                    {
                        m_idle?.Cancel();
