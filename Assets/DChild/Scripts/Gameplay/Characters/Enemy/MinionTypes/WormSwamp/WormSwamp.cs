...
{
    public class WormSwamp : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        private WormSwampAnimation m_animation;
        ...
        public bool Wait()
        {
            if (m_animation.GetCurrentAnimation(0).ToString() != "Move" && m_animation.GetCurrentAnimation(0).ToString() != "Move2")
            {
                //Debug.Log("Must Wait");
        ...
        protected IEnumerator DeathRoutine()
        {
            ...
            m_movement.Stop();
            m_animation.DoDeath();
            yield return new WaitForAnimationComplete(m_animation.animationState, WormSwampAnimation.ANIMATION_DEATH);
        ...
        private IEnumerator TurnRoutine()
        {
            m_waitForBehaviourEnd = true;
            m_animation.DoTurn();
            yield return new WaitForAnimationComplete(m_animation.animationState, WormSwampAnimation.ANIMATION_TURN);
            m_animation.DoIdle();
            yield return null;
            TurnCharacter();
            StopActiveBehaviour();
        ...
        private IEnumerator FlinchRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, WormSwampAnimation.ANIMATION_FLINCH);
            StopActiveBehaviour();
        }
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<WormSwampAnimation>();
