...
{
    public class Nightmare : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        private NightmareAnimation m_animation;
        ...
        public bool Wait()
        {
            if (m_animation.GetCurrentAnimation(0).ToString() != "Attack_charge")
            {
                //Debug.Log("Must Wait");
        ...
        {
            if (m_animation.GetCurrentAnimation(0).ToString() == "Prep_attack")
            {
                return true;
            }
            else
        ...
        protected IEnumerator DeathRoutine()
        {
            ...
            m_movement.Stop();
            m_animation.DoDeath();
            yield return new WaitForAnimationComplete(m_animation.animationState, NightmareAnimation.ANIMATION_DEATH);
            StopActiveBehaviour();
        }
        ...
        private IEnumerator TurnRoutine()
        {
            m_waitForBehaviourEnd = true;
            m_animation.DoTurn();
            yield return new WaitForAnimationComplete(m_animation.animationState, NightmareAnimation.ANIMATION_TURN);
            m_animation.DoIdle();
            yield return null;
            TurnCharacter();
            StopActiveBehaviour();
        ...
        private IEnumerator FlinchRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, Random.Range(0,1) == 1 ? NightmareAnimation.ANIMATION_Flinch: NightmareAnimation.ANIMATION_Flinch2);
            StopActiveBehaviour();
        }
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<NightmareAnimation>();
