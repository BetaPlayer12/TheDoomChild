...
{
    public class Werewolf : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        private WerewolfAnimation m_animation;
        ...
        public void MovetoTarget(Vector2 target)
        {
            ...
            if (Wait())
            {
                ...
                m_rootMotion.useY = false;
                m_animation.SetAnimation(0, "walk2", true).TimeScale = m_hostileMoveSpeedMult;
        ...
        public void MovetoDestination(Vector2 direction)
        {
            ...
            if (Wait())
            {
                m_rootMotion.enabled = false;
                m_rootMotion.useY = false;
                m_animation.SetAnimation(0, "walk2", true).TimeScale = 1;
        ...
        public void AttackScratch2()
        {
            if (Wait())
            {
                m_rootMotion.enabled = true;
                m_rootMotion.useY = false;
                m_animation.DoAttackScratch2();
            }
        }
        #endregion
        ...
        public bool Wait()
        {
            if (m_animation.GetCurrentAnimation(0).ToString() != "walk2")
            {
        ...
        protected IEnumerator DeathRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, WerewolfAnimation.ANIMATION_DEATH2);
        ...
        private IEnumerator TurnRoutine()
        {
            m_waitForBehaviourEnd = true;
            m_animation.DoTurn();
            yield return new WaitForAnimationComplete(m_animation.animationState, WerewolfAnimation.ANIMATION_TURN);
            m_animation.DoIdle1();
            yield return null;
            TurnCharacter();
            StopActiveBehaviour();
        ...
        private IEnumerator FlinchRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, WerewolfAnimation.ANIMATION_FLINCH);
            StopActiveBehaviour();
        }
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<WerewolfAnimation>();
