...
{
    public class WerewolfBrain : MinionAIBrain<Werewolf>, IAITargetingBrain
    {
        [SerializeField]
        ...
        [SerializeField]
        [TabGroup("Ability Ranges")]
        private float m_attackScratchRange;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackChance;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackScratchChance;
        ...
        private void Behaviors()
        {
            switch (m_behaviorCount)
            {
                ...
                case 2:
                    ...
                    {
                        if (GetDistance() < m_attackScratchRange && m_behaviorChance < m_attackScratchChance && GetDistance() > m_castRange)
                        {
                            m_minion.AttackScratch2();
                            m_currentBehavior = 0;
                        }
                        else
                        {
