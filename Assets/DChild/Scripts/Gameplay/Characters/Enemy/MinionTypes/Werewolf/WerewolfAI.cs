...
namespace DChild.Gameplay.Characters.Enemies
{
    ...
    public class WerewolfAI : CombatAIBrain<WerewolfAI.Info>, IResetableAIBrain, IKnockbackableAI
    {
        [System.Serializable]
        public class Info : BaseInfo
        {
            ...
            public override void Initialize()
            {
                ...
                m_scratchAttack.SetData(m_skeletonDataAsset);
#endif
            }
        }
        ...
        private void UpdateAttackDeciderList()
        {
            m_attackDecider.SetList(new AttackInfo<Attack>(Attack.Bite, m_info.biteAttack.range),
                                    new AttackInfo<Attack>(Attack.Scratch, m_info.scratchAttack.range)/**/);
