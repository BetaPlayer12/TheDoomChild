...
{
    public class Owl : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        private OwlAnimation m_animation;
        ...
        protected IEnumerator DeathRoutine()
        {
            ...
            m_movement.Stop();
            m_animation.DoDeath();
            yield return new WaitForAnimationComplete(m_animation.animationState, OwlAnimation.ANIMATION_DEATH);
            StopActiveBehaviour();
        }
        ...
        private IEnumerator TurnRoutine()
        {
            m_waitForBehaviourEnd = true;
            m_animation.DoTurn();
            yield return new WaitForAnimationComplete(m_animation.animationState, OwlAnimation.ANIMATION_TURN);
            m_animation.DoIdle();
            yield return null;
            TurnCharacter();
            StopActiveBehaviour();
        ...
        private IEnumerator FlinchRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, OwlAnimation.ANIMATION_FLINCH);
            StopActiveBehaviour();
        }
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<OwlAnimation>();
