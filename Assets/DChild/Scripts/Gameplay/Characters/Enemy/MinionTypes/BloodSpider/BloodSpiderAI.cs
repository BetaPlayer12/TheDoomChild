...
{
    [AddComponentMenu("DChild/Gameplay/Enemies/Minion/BloodSpider")]
    public class BloodSpiderAI : CombatAIBrain<BloodSpiderAI.Info>, IResetableAIBrain, IKnockbackable
    {
        [System.Serializable]
