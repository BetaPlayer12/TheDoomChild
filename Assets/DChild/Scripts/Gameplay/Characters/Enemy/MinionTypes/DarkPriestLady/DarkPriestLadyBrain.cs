...
{
    public class DarkPriestLadyBrain : MinionAIBrain<DarkPriestLady>, IAITargetingBrain
    {
        [SerializeField]
        ...
        [SerializeField]
        [TabGroup("Ability Ranges")]
        private float m_enragedAttackRange;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_basicAttackChance;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_enragedAttackChance;
        ...
        private void Behaviors()
        {
            switch (m_behaviorCount)
            {
                ...
                case 2:
                    ...
                    {
                        if (GetDistance() < m_enragedAttackRange && m_behaviorChance < m_enragedAttackChance && GetDistance() > m_castRange)
                        {
                            m_minion.AttackEnraged();
                            m_currentBehavior = 0;
                        }
                        else
                        {
        ...
        void Update()
        {
            ...
            m_minion.SetHostility(m_isHostile);
