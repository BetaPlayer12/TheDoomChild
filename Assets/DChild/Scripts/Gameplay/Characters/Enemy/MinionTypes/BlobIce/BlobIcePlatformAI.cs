...
namespace DChild.Gameplay.Characters.Enemies
{
    ...
    public class BlobIcePlatformAI : CombatAIBrain<BlobIcePlatformAI.Info>
    {
        [System.Serializable]
        public class Info : BaseInfo
        {
            ...
            private GameObject m_verticalBlobIceTrail;
            public GameObject verticalBlobIceTrail => m_verticalBlobIceTrail;
            [SerializeField, BoxGroup("Blob Ice Trail")]
            private GameObject m_horizontalBlobIceTrail;
            public GameObject horizontalBlobIceTrail => m_horizontalBlobIceTrail;
        ...
        {
            var instance = GameSystem.poolManager.GetPool<PoolableObjectPool>().GetOrCreateItem(m_info.horizontalBlobIceTrail, gameObject.scene);
