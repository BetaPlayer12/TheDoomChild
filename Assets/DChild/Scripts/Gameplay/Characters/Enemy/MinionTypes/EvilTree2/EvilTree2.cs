...
{
    public class EvilTree2 : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        public void MovetoTarget(Vector2 target)
        {
            ...
            if (Wait())
            {
                ...
                m_fxAnimation.SetAnimation(0, "Move", true).TimeScale = m_hostileMoveSpeedMult;
        ...
        public void MovetoDestination(Vector2 direction)
        {
            ...
            if (Wait())
            {
                ...
                m_fxAnimation.SetAnimation(0, "Move", true).TimeScale = 1;
        ...
        protected IEnumerator DeathRoutine()
        {
            ...
            m_movement.Stop();
            m_animation.DoDeath();
            m_fxAnimation.DoDeath();
            yield return new WaitForAnimationComplete(m_animation.animationState, EvilTree2Animation.ANIMATION_DEATH);
        ...
        private IEnumerator TurnRoutine()
        {
            m_waitForBehaviourEnd = true;
            m_animation.DoTurn();
            m_fxAnimation.DoTurn();
            yield return new WaitForAnimationComplete(m_animation.animationState, EvilTree2Animation.ANIMATION_TURN);
            m_animation.DoIdle();
            m_fxAnimation.DoIdle();
            yield return null;
            TurnCharacter();
        ...
        private IEnumerator FlinchRoutine()
        {
            ...
            m_fxAnimation.DoFlinch();
            yield return new WaitForAnimationComplete(m_animation.animationState, EvilTree2Animation.ANIMATION_FLINCH);
            StopActiveBehaviour();
        }
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<EvilTree2Animation>();
            m_fxAnimation = GetComponentInChildren<EvilTree2FXAnimation>();
