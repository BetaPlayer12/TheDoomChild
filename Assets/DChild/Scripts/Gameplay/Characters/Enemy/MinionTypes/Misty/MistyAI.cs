...
{
    [AddComponentMenu("DChild/Gameplay/Enemies/Minion/Misty")]
    public class MistyAI : CombatAIBrain<MistyAI.Info>, IResetableAIBrain
    {
        [System.Serializable]
                ...
                case State.Attacking:
                    ...
                    switch (m_attackDecider.chosenAttack.attack)
                    {
                        case Attack.AcidBreath:
                            m_attackHandle.ExecuteAttack(m_info.projectile.animation, m_info.idleAnimation.animation);
                            break;
                    }
                    m_attackDecider.hasDecidedOnAttack = false;
