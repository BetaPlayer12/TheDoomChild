...
namespace DChild.Gameplay.Characters.Enemies
{
    ...
    public class SkullSpiderAI : CombatAIBrain<SkullSpiderAI.Info>
    {
        ...
        public class Info : BaseInfo
        {
            ...
            [SerializeField, ValueDropdown("GetAnimations")]
            private string m_assembleAnimation;
            public string assembleAnimation => m_assembleAnimation;
            [SerializeField, ValueDropdown("GetAnimations")]
        ...
        private void Update()
        {
            ...
            switch (m_stateHandle.currentState)
            {
                ...
                case State.Turning:
                    ...
                    var turnAnim = UnityEngine.Random.Range(0, 2) == 0 ? m_info.turn1Animation : m_info.turn2Animation;
