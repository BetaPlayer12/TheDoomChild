...
{
    [AddComponentMenu("DChild/Gameplay/Enemies/Minion/Jailer")]
    public class JailerAI : CombatAIBrain<JailerAI.Info>, IResetableAIBrain
    {
        [System.Serializable]
        public class Info : BaseInfo
        {
            ...
            [SerializeField]
            private SimpleAttackInfo m_attack3_2 = new SimpleAttackInfo();
            public SimpleAttackInfo attack3_2 => m_attack3_2;
            ...
            [SerializeField, ValueDropdown("GetAnimations")]
            private string m_stationaryAnimation;
            public string stationaryAnimation => m_stationaryAnimation;
            [SerializeField, ValueDropdown("GetAnimations")]
            ...
            public override void Initialize()
            {
                ...
                m_attack3_2.SetData(m_skeletonDataAsset);
#endif
            }
        }
        ...
        private IEnumerator ChargeAttackRoutine()
        {
            ...
            m_animation.SetAnimation(0, m_info.attack3_2.animation, true);
            m_animation.animationState.GetCurrent(0).MixDuration = 0;
            while (!IsTargetInRange(25))
            {
                m_movement.MoveTowards(Vector2.one * transform.localScale.x, m_info.move.speed * 2f);
                yield return null;
            }
            m_animation.EnableRootMotion(true, false);
            m_animation.SetAnimation(0, m_info.attack3.animation, false).TimeScale = .5f;
