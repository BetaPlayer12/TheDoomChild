...
{
    public class Marrionette2Brain : MinionAIBrain<Marrionette2>, IAITargetingBrain
    {
        [SerializeField]
        ...
        [SerializeField]
        private RaySensor m_bodySlamSensor;
        [SerializeField]
        ...
        [SerializeField]
        private float m_bodySlamDuration;
        private float m_currentSlamDuration;
        [SerializeField]
        ...
        private void NormalMode()
        {
            ...
            {
                if (m_bodySlamSensor.isDetecting || m_terrainSensor.isDetecting)
                {
                    Debug.Log("End Body Slam");
                    m_currentSlamDuration = 0;
                    m_minion.StopBodySlam();
                    //NEW
                    //m_target = null;
                    //m_aggroSensor.enabled = false;
                }
                //if (!m_bodySlamSensor.isDetecting || m_currentSlamDuration < m_bodySlamDuration)
                //{
                //    m_currentSlamDuration += Time.deltaTime;
                //}
                //else
                //{
                //    Debug.Log("End Body Slam");
        ...
        void Update()
        {
            ...
            if (transform.localScale.x == -1)
            {
                m_bodySlamSensor.SetRotation(0f);
            }
            else if (transform.localScale.x == 1)
            {
                m_bodySlamSensor.SetRotation(180f);
            }
