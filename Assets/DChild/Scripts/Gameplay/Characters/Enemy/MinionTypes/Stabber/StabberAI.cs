...
namespace DChild.Gameplay.Characters.Enemies
{
    ...
    public class StabberAI : CombatAIBrain<StabberAI.Info>, IResetableAIBrain
    {
        ...
        public class Info : BaseInfo
        {
            ...
            [SerializeField, ValueDropdown("GetAnimations"), TitleGroup("Attack")]
            private string m_attackChargeLoopAnimation;
            public string attackChargeLoopAnimation => m_attackChargeLoopAnimation;
            [SerializeField, ValueDropdown("GetAnimations"), TitleGroup("Attack")]
            private string m_attackLoopAnimation;
            public string attackLoopAnimation => m_attackLoopAnimation;
