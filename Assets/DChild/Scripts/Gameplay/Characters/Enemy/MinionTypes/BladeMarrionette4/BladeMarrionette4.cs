...
{
    public class BladeMarrionette4 : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        private BladeMarrionette4Animation m_animation;
        ...
        protected IEnumerator DeathRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, BladeMarrionette4Animation.ANIMATION_DEATH);
        ...
        private IEnumerator TurnRoutine()
        {
            m_waitForBehaviourEnd = true;
            m_animation.DoTurn();
            yield return new WaitForAnimationComplete(m_animation.animationState, BladeMarrionette4Animation.ANIMATION_TURN);
            m_animation.DoIdle();
            yield return null;
            TurnCharacter();
            StopActiveBehaviour();
        ...
        private IEnumerator FlinchRoutine()
        {
            ...
            yield return new WaitForAnimationComplete(m_animation.animationState, BladeMarrionette4Animation.ANIMATION_DAMAGE);
            StopActiveBehaviour();
        }
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<BladeMarrionette4Animation>();
