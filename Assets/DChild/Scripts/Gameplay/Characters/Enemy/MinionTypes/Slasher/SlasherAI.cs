...
namespace DChild.Gameplay.Characters.Enemies
{
    ...
    public class SlasherAI : CombatAIBrain<SlasherAI.Info>, IResetableAIBrain
    {
        ...
        public class Info : BaseInfo
        {
            ...
            [SerializeField, TabGroup("Attack")]
            private BasicAnimationInfo m_attack2Animation;
            public BasicAnimationInfo attack2Animation => m_attack2Animation;
            ...
            public override void Initialize()
            {
                ...
                m_attack2Animation.SetData(m_skeletonDataAsset);
