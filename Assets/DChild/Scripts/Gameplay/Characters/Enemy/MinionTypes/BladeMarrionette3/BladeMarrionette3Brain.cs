...
{
    public class BladeMarrionette3Brain : MinionAIBrain<BladeMarrionette3>, IAITargetingBrain
    {
        [SerializeField]
        ...
        [SerializeField]
        [TabGroup("Ability Ranges")]
        private float m_attackLongRange;
        [SerializeField]
        [TabGroup("Ability Ranges")]
        private float m_attackTwitchRange;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackChance;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackLongChance;
        [SerializeField]
        [TabGroup("Ability Chance")]
        private float m_attackTwitchChance;
        ...
        private void Behaviors()
        {
            switch (m_behaviorCount)
            {
                ...
                case 2:
                    ...
                    {
                        if (GetDistance() < m_attackLongRange && m_behaviorChance < m_attackLongChance && GetDistance() > m_castRange)
                        {
                            m_canIdle = false;
                            m_minion.AttackLong();
                            m_currentBehavior = 0;
                ...
                case 3:
                    ...
                    {
                        if (GetDistance() < m_attackTwitchRange && m_behaviorChance < m_attackTwitchChance && GetDistance() > m_castRange)
                        {
                            m_canIdle = false;
                            m_minion.AttackTwitch();
                            m_currentBehavior = 0;
                        }
                        else
                        {
