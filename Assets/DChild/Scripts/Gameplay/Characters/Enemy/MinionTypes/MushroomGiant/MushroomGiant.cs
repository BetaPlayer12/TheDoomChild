...
{
    public class MushroomGiant : Minion, IFlinch, ITerrainPatroller
    {
        [SerializeField]
        ...
        [SerializeField]
        private MushroomGiantFXAnimation m_deathFX;

        private MushroomGiantAnimation m_animation;
        ...
        protected override void Awake()
        {
            ...
            m_animation = GetComponent<MushroomGiantAnimation>();
