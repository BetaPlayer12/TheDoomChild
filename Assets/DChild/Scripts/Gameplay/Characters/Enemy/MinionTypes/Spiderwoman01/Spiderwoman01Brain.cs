...
{
    public class Spiderwoman01Brain : MinionAIBrain<Spiderwoman01>, IAITargetingBrain
    {
        [SerializeField]
        ...
        private void Behaviors()
        {
            switch (m_behaviorCount)
            {
                ...
                case 3:
                    ...
                    {
                        if (GetDistance() < m_attack3Range && m_behaviorChance < m_attack3Chance && GetDistance() > m_castRange)
                        {
                            m_minion.Attack3();
                            m_currentBehavior = 0;
                        }
