...
namespace DChildDebug.Spine.Tests
{
    ...
    public class SpineStressTestManager : MonoBehaviour
    {
        [SerializeField]
        ...
        private IEnumerator SpineStressTestRoutine(SkeletonDataAsset skeletonData, string minionName)
        {
            ...
            else
            {
                ...
                {
                    yield return InstantiateInstances(skeletonData, i, endofFrame);
        ...
        private IEnumerator TestRoutine()
        {
            ...
            for (int i = 0; i < m_minionPrefabs.Count; i++)
            {
                ...
                yield return SpineStressTestRoutine(minion, minion.name);
            }
            GenerateLogToFile();
        }
